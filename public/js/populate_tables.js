...
var chatbotSchemaA = [{identity: "happy", description: "I am feeling good!", image_url: "img/face1.png", bot_name: "HappyBot"},
...
var chatbotSchema0 = [ {keywords: [ 'hello', 'hi', 'morning', 'evening' ], response: 'Hello!'},
						...
						{keywords: [ 'link2' ], response: 'www.google.com'},
						{keywords: [ 'link3' ], response: 'google.com'},
						{keywords: [ 'email' ], response: 'example@gmail.com'}];
